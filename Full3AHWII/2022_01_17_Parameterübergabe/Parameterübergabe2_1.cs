...
namespace _20220117_Parameterübergabe2
{
    class Program
    {
        ...
        static void Kegelberechnen(double radius, double hoehe, ref double volumen, ref double oberflaeche)
        {
        ...
        static void Main(string[] args)
        {
            ...
            Kegelberechnen(radius, hoehe, ref volumen, ref oberflaeche);
