...
namespace _2021_12_06_Struktur_Rechteck
{
    class Program
    {
        ...
        static int Vergleichen(Rechteck rechteck1, Rechteck rechteck2)
        {
            //Calculate the "Fläche"
            double flaeche1 = Flaeche(rechteck1);
            double flaeche2 = Flaeche(rechteck2);
        ...
        static void Main(string[] args)
        {
            ...
            rechteck2.Laenge = 10;
            rechteck2.Breite = 5;
            Console.WriteLine("Die Fläche des {0}.Rechteck ist größer.", Vergleichen(rechteck1,rechteck2));
